...
| arc-start-altitude | Arc object accessor function, attribute or a numeric constant for the line's start altitude. | 0 |
...
| arc-end-altitude | Arc object accessor function, attribute or a numeric constant for the line's end altitude. | 0 |
...
| label-altitude | Label object accessor function, attribute or a numeric constant for the label altitude in terms of globe radius units. | 0.002 |

 ...
 */
if (!AFRAME.components.hasOwnProperty('globe')) {
  AFRAME.registerComponent('globe', {
    schema: {
      ...
      globeCurvatureResolution: { type: 'number', default: 4 },
      ...
      arcStartAltitude: { parse: parseAccessor, default: 0 },
      arcEndLat: { parse: parseAccessor, default: 'endLat' },
      arcEndLng: { parse: parseAccessor, default: 'endLng' },
      arcEndAltitude: { parse: parseAccessor, default: 0 },
      ...
      particlesData: { parse: parseJson, default: [] },
      particlesList: { parse: parseAccessor, default: function(d) { return d; } },
      particleLat: { parse: parseAccessor, default: 'lat' },
      particleLng: { parse: parseAccessor, default: 'lng'  },
      particleAltitude: { parse: parseAccessor, default: 0.01 },
      particlesSize: { parse: parseAccessor, default: 0.05 },
      particlesSizeAttenuation: { parse: parseAccessor, default: true },
      particlesColor: { parse: parseAccessor, default: function () { return 'white'; } },
      particlesTexture: { parse: parseAccessor, default: undefined },
